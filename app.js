...
const spreadsConfig = {
  ...
  "gypsy-cross": {
    ...
    slots: [
      ...
      { name: "彼此的關係阻礙", x: 50, y: 12 },
      { name: "未來的關係發展", x: 50, y: 88 }
    ]
  },
  "two-options": {
    title: "二擇一牌陣",
    slots: [
      ...
      { name: "選擇 A 的結果", x: 25, y: 10 },
      { name: "選擇 B 的過程", x: 70, y: 45 },
      { name: "選擇 B 的結果", x: 75, y: 10 }
    ]
  },
  "cross": {
    title: "十字架牌陣",
    slots: [
      ...
      { name: "你的目標與期望", x: 50, y: 10 },
      { name: "解決問題的對策", x: 75, y: 50 },
      { name: "最終可能的結果", x: 50, y: 90 }
    ]
  },
  "horseshoe": {
    title: "馬蹄鐵牌陣",
    slots: [
      { name: "過去的背景影響", x: 20, y: 88 },
      { name: "目前的現狀", x: 25, y: 38 },
      { name: "近未來的演變", x: 40, y: 12 },
      { name: "建議的行動對策", x: 60, y: 12 },
      { name: "周圍環境的阻礙", x: 75, y: 38 },
      { name: "最終發展結果", x: 80, y: 88 }
    ]
  },
  "hexagram": {
    title: "六芒星牌陣",
    slots: [
      { name: "過去的因素", x: 50, y: 10 },
      { name: "現在的局勢", x: 75, y: 68 },
      { name: "未來的期望", x: 25, y: 68 },
      { name: "對策與建議", x: 25, y: 35 },
      { name: "環境與他人影響", x: 75, y: 35 },
      { name: "你的潛意識意圖", x: 50, y: 90 },
  ...
  "celtic-cross": {
    ...
    slots: [
      ...
      { name: "位置 7：你目前的自我狀態", x: 80, y: 90 },
      { name: "位置 8：環境與周遭人影響", x: 80, y: 62 },
      { name: "位置 9：你的希望或恐懼", x: 80, y: 38 },
      { name: "位置 10：問題最終發展結果", x: 80, y: 10 }
    ]
  }
};
